    ...
    <div className={`relative ${className}`} ref={searchRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-300 transition-all"
